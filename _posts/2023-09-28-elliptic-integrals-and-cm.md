...
where $\alpha=\sqrt{1+\sqrt{2}+\sqrt{2+2\sqrt{2}}}$. I played with this problem off and on but did not make much progress on it other than noting it was a rational multiple of
