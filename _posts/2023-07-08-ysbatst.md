...
this is the set of points the punch fails to eliminate when applied at $P$. Note that we are including the 'circle' of radius $0$ becasue $P$ is not a transcendental distance from itself.
